...
# SQUAD-Public OS & Systems Audit — Kernel
...
- `squad-method/agents/kernel.md` — OS/Systems Architect lens
- `squad-method/fragments/stack/cpp.md` — C/C++ patterns (if detected)
- `squad-method/fragments/rubric/cpp.md` — C/C++ review checks (if detected)
- `squad-method/fragments/rubric/systems.md` — systems review checks

**Phase-gated loading:**
- Phase 3: `squad-method/agents/aegis.md` — security lens on systems code
- Phase 3: `squad-method/agents/raven.md` — adversarial review
