...
# SQUAD-Public Refresh Git — Enrich CONTEXT.md from PR History
...
Read `squad-method/config.yaml` for GitHub host config.
...
Tag: `<!-- squad-refresh-git: [date], source: [N] PRs, incremental -->`
...
Save to: `squad-method/output/reports/refresh-git-[date].md`
