...
# SQUAD-Public QA Task — End-to-End QA Workflow
...
- `squad-method/agents/sentinel.md` — Sentinel drives this workflow
- `squad-method/agents/nova.md` — AC validation

**Phase-gated loading:**
- Phase 1: `squad-method/fragments/kg-query-protocol.md`
- Phase 4: `squad-method/agents/cipher.md`, `squad-method/fragments/tdd-workflow.md`
- Phase 5: `squad-method/agents/forge.md`, `squad-method/agents/raven.md`, `squad-method/fragments/tracking-protocol.md`
