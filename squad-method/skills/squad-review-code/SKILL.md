...
# SQUAD-Public Review Code — Quick Pre-Commit Review
...
- `squad-method/fragments/review-rubric.md` — rubric checks
...
**Load now:** `squad-method/agents/forge.md`, `squad-method/agents/raven.md`,
  `squad-method/agents/cipher.md`, `squad-method/fragments/review-protocol.md`
...
```bash
echo '{"ts":"[ISO_DATE]","command":"review-code","repo":"[REPO]","outcome":"[completed|user_aborted]","review_verdict":"[APPROVE|REQUEST_CHANGES]","findings":{"critical":[N],"major":[N],"minor":[N],"nit":[N]}}' >> squad-method/output/tracking.jsonl
```
