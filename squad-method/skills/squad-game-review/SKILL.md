...
# SQUAD-Public Game Review — Pixel + Quest + Lore + Titan
...
- `squad-method/agents/pixel.md` — Game Developer lens
- `squad-method/agents/quest.md` — Game Designer lens
- `squad-method/fragments/stack/game-dev.md` — game dev patterns
- `squad-method/fragments/rubric/game-dev.md` — game dev review checks

**Phase-gated loading:**
- Phase 3: `squad-method/agents/lore.md` — Narrative review
- Phase 4: `squad-method/agents/titan.md` — Quality enforcement
- Phase 4: `squad-method/agents/flux.md` — Creative alternatives
