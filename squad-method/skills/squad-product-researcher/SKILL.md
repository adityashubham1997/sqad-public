...
# SQUAD-Public Product Researcher — All-Source Deep Research

Two agents: **Oracle** (primary researcher), **Compass** (product framing).

Read `squad-method/agents/oracle.md`, `squad-method/agents/compass.md`,
...
Save to: `squad-method/output/reports/research-[topic]-[date].md`
