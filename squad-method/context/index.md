...
# SQUAD-Public Context Tree

This is the root index for SQUAD-Public's tree-based context system.
...
- Skills reference context nodes via `squad-method/context/{node}.md`
- The LLM reads this index first, then navigates to the needed node
- Fragments in `squad-method/fragments/` provide reusable stack/cloud knowledge
- Agent personas in `squad-method/agents/` provide role-specific behavior
