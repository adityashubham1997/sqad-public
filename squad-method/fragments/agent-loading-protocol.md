...
```markdown
**Bootstrap (read now):**
- `squad-method/agents/_base-agent.md`
- `squad-method/config.yaml`
- `squad-method/agents/forge.md`         ← primary agent

**Phase-gated loading:**
- Phase 2: `squad-method/agents/raven.md`
- Phase 3: `squad-method/agents/cipher.md`, `squad-method/fragments/tdd-workflow.md`
```
