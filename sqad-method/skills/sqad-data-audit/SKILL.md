...
# SQAD-Public Data & ML Audit — Neuron + Prism
...
- `sqad-method/agents/neuron.md` — ML/Data Science lens
- `sqad-method/agents/prism.md` — Data Analyst lens
- `sqad-method/fragments/stack/data-science.md` — ML/analytics patterns
- `sqad-method/fragments/rubric/data-science.md` — ML/analytics review checks
