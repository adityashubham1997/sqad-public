...
# SQAD-Public Infrastructure Audit — Phoenix + Stratos + Kernel
...
- `sqad-method/agents/phoenix.md` — DevOps/SRE lens
- `sqad-method/agents/stratos.md` — Cloud Architect lens
- `sqad-method/fragments/cloud/monitoring.md` — observability patterns
- `sqad-method/fragments/rubric/observability.md` — infra review checks

**Phase-gated loading:**
- Phase 2: `sqad-method/agents/kernel.md` — systems-level review
- Phase 2: `sqad-method/fragments/cloud/ansible.md` — if Ansible detected
- Phase 2: `sqad-method/fragments/cloud/azure-devops.md` — if Azure DevOps detected
- Phase 3: `sqad-method/agents/aegis.md` — security lens on infra
