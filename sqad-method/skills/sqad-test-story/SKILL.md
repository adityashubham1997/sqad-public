...
# SQAD-Public Test Story — Story-Aware Test Generation
...
- `sqad-method/agents/cipher.md` — primary

**Step-gated loading:**
- Step 2: `sqad-method/fragments/tdd-workflow.md`
- Step 3: `sqad-method/fragments/kg-query-protocol.md`
- Step 6: `sqad-method/agents/forge.md`
...
**Load now:** `sqad-method/fragments/tdd-workflow.md`
...
**Load now:** `sqad-method/agents/forge.md`
