...
# SQAD-Public AI Workflow Audit — Spark + Muse
...
- `sqad-method/agents/spark.md` — AI Developer lens
- `sqad-method/agents/muse.md` — AI Researcher lens
- `sqad-method/fragments/stack/generative-ai.md` — patterns context
- `sqad-method/fragments/rubric/generative-ai.md` — review checks
