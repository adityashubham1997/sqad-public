...
# SQAD-Public Database Audit — Dynamo + Index
...
- `sqad-method/agents/_base-architect.md` — architect protocols
- `sqad-method/agents/dynamo.md` — Database Architect lens
- `sqad-method/agents/index.md` — Query Optimizer lens
- `sqad-method/fragments/stack/database.md` — DB patterns
- `sqad-method/fragments/rubric/database.md` — DB review checks
