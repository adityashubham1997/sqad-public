...
# SQAD-Public Create PRD — Multi-Agent Product Requirements Document
...
- `sqad-method/agents/compass.md`, `sqad-method/agents/nova.md`
- `sqad-method/agents/atlas.md`, `sqad-method/agents/oracle.md`
- `sqad-method/agents/forge.md`
...
Save to: `sqad-method/output/specs/prd-[feature]-[date].md`
