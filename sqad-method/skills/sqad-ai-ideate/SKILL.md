...
# SQAD-Public AI Ideation — Muse + Spark

Generate and evaluate AI/agentic automation ideas tailored to the project's stack.

**Bootstrap (read now):**
- `sqad-method/config.yaml` — team config + detected stack
- `sqad-method/agents/_base-agent.md` — base protocols
- `sqad-method/agents/muse.md` — AI Researcher lens (leads)
- `sqad-method/agents/spark.md` — AI Developer lens (feasibility)
- `sqad-method/fragments/stack/generative-ai.md` — AI patterns
