 ...
 * Uses Cursor project rules format: YAML frontmatter (description, globs, alwaysApply)
 * followed by markdown body. Verified compatible with Cursor 0.44+ (.mdc format).
 */
